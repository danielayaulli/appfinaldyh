...
MONGODB_URI = "mongodb+srv://dfyaullih_db_user:UPD2025@clusterdyaullih.8sjn3ty.mongodb.net/" 
...
st.title("💬 Chat PDF con MongoDB + Gemini + Cohere FINAL DE CLOUD COMPUTING: "+USER)
